...
void UART_Init(void)
{
  ...
  SYSCTL_RCGC1_R |= SYSCTL_RCGC1_UART0; // activate UART0 // RCGC1 Enable clock  done
...
//------------UART_InCharNonBlocking [Function 2 ] ------------
...
//-----------------------UART_ConvertDistance [Function 8 ] -----------------------
